<%@ Page Language="VB" AutoEventWireup="false" CodeFile="homen.aspx.vb" Inherits="Sample" %>
				...
				<div class="container-fluid serarc-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item">
								<a class="nav-link" href="about.html">Terms and Conditions</a>
							  </li>
		...
		<div class="bannerhny-content">
			...
			<div class="content-baner-inf">
				<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
					...
					<a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next" style="background-color: #FFFF00">
						<span class=" fa-arrow-circle-right" aria-hidden="False"></span>
		...
		<div class="container py-lg-5">
			...
			<div class="welcome-grids row mt-5">
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="Sprystore-Starter/assets/images/grid1.jpg" class="img-fluid" alt="" />
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="Sprystore-Starter/assets/images/grid3.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="Sprystore-Starter/assets/images/grid2.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="Sprystore-Starter/assets/images/grid4.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="Sprystore-Starter/assets/images/grid5.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
				...
				<div class="col-lg-2 col-md-4 col-6 welcome-image">
						<div class="boxhny13">
								<a href="#URL">
										<img src="Sprystore-Starter/assets/images/grid6.jpg" class="img-fluid" alt="" />
								<div class="boxhny-content">
									<h3 class="title">Product</h3>
								</div>
							</a>
			 ...
			 <div class="container py-lg-5">
					<div class="align-photo-6-inf-cols row">
						...
						<div class="photo-6-inf-left col-lg-6">
								<img src="Sprystore-Starter/assets/images/1.jpg" class="img-fluid" alt="">
						</div>
					</div>
				 </div>
			 </div>
...
<!-- //customers-->
<section class="w3l-subscription-6" id="101">
	<!--/customers -->
